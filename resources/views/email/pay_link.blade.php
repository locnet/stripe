                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="padding: 20px 0 0 0; font-size: 20px;
                                             line-height: 25px; font-family: Helvetica, Arial, sans-serif; 
                                             color: #666666;" class="padding-copy">
                                         Aplicacion de pago por tarjeta en Romfly Viajes</td>
                                        </tr>
                                        <tr>
                ...
                <tr>
                    <td align="left" style="font-size: 12px; line-height: 18px;
                     font-family: Helvetica, Arial, sans-serif; color:#666666;">
                        Carretera de Loeches 33 Local 1, Arganda del Rey, 28500-Madrid
                        <br>
